 ...
 * Slider data helper
 */
namespace Excellence\Slider\Helper;
...
{
    /**
     * Path to store config where count of slider posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'slider/view/items_per_page';
     ...
     *
     * @param Excellence\Slider\Model\Slider $item
     * @param integer $width
     * @param integer $height
     * @return bool|string
     */
    public function resize(\Excellence\Slider\Model\Slider $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Slider Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Slider Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getSliderPerPage()
    {
